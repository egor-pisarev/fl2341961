...
use egorpisarev\document\models\AttachmentSearch;
...
//    }
    ...
    public function actionDelete($id)
    {
        ...
        if (Yii::$app->getRequest()->isAjax) {
            $dataProvider = $document->getAttachments();
    ...
    {
        return Yii::getAlias('@vendor/egorpisarev/yii2-document/views/attachment');
    }
}
